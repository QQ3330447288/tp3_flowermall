                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <a href="/index.php/Admin/MemberLevel/add" class="btn btn-primary pull-right">添加会员等级</a>
                        </div>
                        <table class="table table-hover text-center" style="margin-top: 5px">
                            ...
                            <tr>
                                <td> <?php echo ($v['lever_name']); ?></td>
                                <td> <?php echo ($v['score_upper']); ?></td>
                                <td> <?php echo ($v['score_lower']); ?></td>
                                <td>
